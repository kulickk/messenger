...
interface WasmModule {
  _td_emscripten_create_client_id(): number;
  _td_emscripten_send(_0: number, _1: number): void;
  _td_emscripten_receive(): number;
  _td_emscripten_execute(_0: number): number;
  _td_emscripten_get_timeout(): number;
